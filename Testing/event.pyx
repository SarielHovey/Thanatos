...
cdef class FillEvent(Event):
    ...
    def __init__(self, timeindex, symbol, exchange, quantity,direction, fill_cost, commission=None):
        ...
        print("Fill Event: %s %s deal at %s with Quantity %s of Direction %s with Commission %s" %(self.timeindex, self.symbol, self.exchange, self.quantity, self.direction, self.commission))
